...
<div class="row">
                        ...
                        <div class="col-sm-8">
                            <div id="mainImage">
                                <img src="https://static1.squarespace.com/static/55c37beae4b0336075603f86/55c3cd80e4b01531b3208f2e/5603032be4b008bd0ad4e6fb/1455546867623/?format=1500w" alt="" class="img-responsive">
                            </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="box">
							<div class= "row">
                                <h2 class="text-center"><strong>Evtents name</strong></h2>
								<hr>
								</div>
								
								<div class= "row text-center ">
                                <h5><strong>$124.00</strong><h5>
								<h5 style= "opacity: 0.4 ;">15 members already booked<h5>
              ...
              <div class="tab-pane" id="Location">
                ...
                <div class="row">
                    <div class="span6">
                      ...
                      <p><div style="text-decoration:none; overflow:hidden; height:500px; width:500px; max-width:100%;">
					  <div id="display-google-map" style="height:100%; width:100%;max-width:100%;">
					  <iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=N+1,+Mannheim,+Germany&key=AIzaSyAN0om9mFmy1QN6Wf54tXAowK4eT0ZUPrU">

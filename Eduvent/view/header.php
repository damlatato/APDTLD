			...
			<div class="container">
				...
				<div class="collapse navbar-toggleable-xs" id="collapseEx2">
					<a class="navbar-brand" href="../Eduvent/index.php"> <span> <img
							...
							width=""> <img class="head-logo hidden"
							src="../Eduvent/view/images/logo-small.png" height="48" width="">
							<img class="head-logo hidden"
							src="../Eduvent/view/images/logo-small-yellow.jpg" height="40"
							width="">
					</span>
					</a>
					<!--Links-->
					<ul class="nav navbar-nav">
						...
						<li class="nav-item"><a class="nav-link"
							href="../Eduvent/index.php?page=event-proposals">Event proposals</a>
						</li>
						<li class="nav-item"><a class="nav-link"
						...
						<li id="shoppingcartmenu" class="nav-item"><a class="nav-link"
							href="../Eduvent/index.php?page=shoppingCart"> <i
								class="fa fa-shopping-cart left"></i> Shopping cart<?php if (!isset($_POST['purchaseshoppingCart'])){ 
									printQuantityOfSelectedEvents();
} ?>
						</a>
						</li>
						<li class="nav-item">&nbsp&nbsp <label class="switch"> <input
								class="theme-switch" type="checkbox">
...
?>
						...
						<li class="nav-item dropdown"><a
							class="hd-account nav-link dropdown-toggle" id="dropdownMenu1"
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
								<b><img src="../Eduvent/view/images/user.png" height="35"
									width=""> <span class="glyphicon glyphicon-user"></span>&nbsp;<?php echo $_SESSION['username']; ?>&nbsp;</b>
						</a>
							<div class="dropdown-menu dropdown-default"
								...
								<a class="dropdown-item waves-effect waves-light"
									...
									href="../Eduvent/index.php?page=create-event">Create Event</a>
								<a class="dropdown-item waves-effect waves-light"
									href="../Eduvent/index.php?page=profile">Bookings</a> <a
									class="dropdown-item waves-effect waves-light"
									href="../Eduvent/index.php?page=analytics">Eduvent Analytics</a>
								<a class="dropdown-item waves-effect waves-light"
...
?>
						<li><a href="../Eduvent/index.php?page=login">
								<button type="button" class="btn btn-standard" id="btn_login">Log
									in</button>
						</a>
						</li>
						<?php 

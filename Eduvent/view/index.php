...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="view overlay hm-white-light z-depth-1-half">
				<img
					src="http://mdbootstrap.com/images/proffesions/slides/socialmedia/img%20(2).jpg"
					class="img-fluid " alt="">
				<div class="mask"></div>
			</div>
			<br>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="view overlay hm-white-slight">
						<img
							src="http://mdbootstrap.com/images/regular/city/img%20(2).jpg"
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="view overlay hm-white-slight">
						<img
							src="http://mdbootstrap.com/images/regular/city/img%20(4).jpg"
							class="img-fluid" alt=""> <a href="#">
							<div class="mask"></div>
						</a>
					</div>
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="view overlay hm-white-slight">
						<img
							src="http://mdbootstrap.com/images/regular/city/img%20(8).jpg"
							class="img-fluid" alt=""> <a href="#">
							<div class="mask"></div>
						</a>
					</div>
	...
	<footer class="page-footer grey darken-1 center-on-small-only">
		...
		<div class="footer-copyright">
			<div class="container-fluid">
				© 2015 Copyright: <a href="http://www.eduvent.com">
					Eduvent.com </a>
